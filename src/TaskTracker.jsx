...
const TaskTracker = () => {
    ...
    return ( 
        <section className="container">
            <h1 className="text-center text-secondary">Task Tracker</h1>
        <div className="contain-div ">
            ...
            <section className="d-flex justify-content-around pt-3 ">
                            ...
                            <div className="d-flex justify-content-center p-3 mt-2 mb-2">
                                {
                                    value === false ? <button  onClick={() => handleSubmit()} className=" w-25 bg-success text-light add-task"  >Add Task</button> :
                                    <button onClick={() => handleUpdate(number)} className="w-25 orange " >Save</button>
                                }
                            </div>
                </form>
        </div>
